  ...
  <section class="mesh2-sec mesh3-open">
    <div class="mesh3-inner">
      ...
      <div class="mesh-hero-photo">
        ...
        <h1 class="mesh-hero-title"><span class="mesh-hl"><svg class="mesh-hl-mark" viewBox="0 0 300 80" preserveAspectRatio="none" aria-hidden="true"><defs><filter id="hlrough" x="-8%" y="-25%" width="116%" height="150%"><feTurbulence type="fractalNoise" baseFrequency="0.022 0.075" numOctaves="2" seed="4" result="t"/><feDisplacementMap in="SourceGraphic" in2="t" scale="11" xChannelSelector="R" yChannelSelector="G"/></filter><linearGradient id="hlfill" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#f4e24a" stop-opacity="0.42"/><stop offset="0.05" stop-color="#f4e24a" stop-opacity="0.9"/><stop offset="0.5" stop-color="#efd838" stop-opacity="0.95"/><stop offset="0.95" stop-color="#f4e24a" stop-opacity="0.9"/><stop offset="1" stop-color="#f4e24a" stop-opacity="0.46"/></linearGradient></defs><rect x="3" y="9" width="294" height="48" rx="22" fill="url(#hlfill)" filter="url(#hlrough)" opacity="0.58"/><rect x="6" y="23" width="291" height="48" rx="22" fill="url(#hlfill)" filter="url(#hlrough)" opacity="0.58"/></svg>The Mesh</span></h1>
